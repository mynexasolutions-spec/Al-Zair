...
function LoginContent() {
  ...
  const cartNotice = searchParams.get('redirect') === '/cart';
        ...
        <div className="rounded-2xl border border-[#dccbb4] bg-[#ede5d8]/85 p-8 sm:p-10 shadow-[0_16px_40px_rgba(72,53,35,0.08)] backdrop-blur-md">
          ...
          <div className="text-center mb-6">
            ...
            <p className="mt-1 text-xs text-[#5e5850]">
              Access your personalized account, orders, and cart
            </p>

            {cartNotice && (
              <div className="mt-4 rounded-xl border border-[#c49a4a]/40 bg-[#c49a4a]/10 p-3 text-xs font-semibold text-[#8a6828] text-left flex items-start gap-2">
                <ShieldCheck size={16} className="shrink-0 mt-0.5 text-[#a9823b]" />
                <span>Please sign in or create an account to view and manage your shopping cart.</span>
              </div>
            )}
          </div>
